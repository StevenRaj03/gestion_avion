import { IonButton, IonCard, IonCardContent, IonCardHeader, IonCardSubtitle, IonCardTitle, IonContent, IonHeader, IonInput, IonItem, IonLabel, IonList, IonNote, IonPage, IonSelect, IonSelectOption, IonTitle, IonToolbar } from '@ionic/react';
...
const Login: React.FC = () => {
  ...
  const [mdp, setMdp] = useState('mdp1');
  ...
  const handleChangeMdp = (event: React.ChangeEvent<HTMLInputElement>) : void=> {
    ...
    <IonPage>
      <IonContent fullscreen>
        ...
        <IonCardHeader>
            ...
            <IonCardSubtitle>Connectez-vous avec votre compte.</IonCardSubtitle>
        </IonCardHeader>
        <img src={`data:image/jpeg;base64,${data}`} />
        <IonCardContent>
            <form action='authentification' className='ion-padding' id="form">
                <IonItem>
                    <IonLabel position="floating">Email</IonLabel>
                    <IonInput type="email" name="email" id="email" value={email} ></IonInput>
                    <IonNote slot="helper" >Entrer l'adresse mail</IonNote>
                    <IonNote slot="error">Email invalide</IonNote>
                </IonItem>
                <IonItem>
                    <IonLabel position="floating">Mot de passe</IonLabel>
                    <IonInput type="password" name="mdp" id="mdp" value={mdp}></IonInput>
                    <IonNote slot="helper">Entrer le mot de passe</IonNote>
                    <IonNote slot="error">Mot de passe invalide</IonNote>
                </IonItem>
                
                <IonButton type='submit' expand='block' className='ion-margin-top' color="success">
                    Connexion
                </IonButton>
